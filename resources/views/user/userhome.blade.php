                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="user-menu d-flex">
                                    <div class="user-name text-end me-3">
                                        ...
                                        <p class="mb-0 text-sm text-gray-600">{{ Auth::guard('user')->user()->email}}</p>
                                    </div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#MyProfile"><i class="icon-mid bi bi-person me-2"></i> My
                                        Profile</a>
                                </li>
                                <li>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ Auth::guard('user')->user()->name }}" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Email</label>
                                        <input type="text" class="form-control" placeholder="{{ Auth::guard('user')->user()->email }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
