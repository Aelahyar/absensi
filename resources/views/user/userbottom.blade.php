    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item item {{ Route::is('dashboarduser') ? 'active' : '' }} ">
                ...
                <li class="sidebar-item {{ Route::is('absensi*') ? 'active' : '' }} has-sub">
                    ...
                    <ul class="submenu">
                        @foreach ($kelasList as $kelas)
                            <li class="submenu-item {{ request()->route('kelas') == $kelas->id_mkelas ? 'active' : '' }}">
                                <a href="{{ route('absensi.index', ['kelas' => $kelas->id_mkelas]) }}" class="submenu-link">
                ...
                {{-- <li class="sidebar-item {{ Route::is('absensi*') ? 'active' : '' }} has-sub">
                    ...
                    <ul class="submenu">
                        @foreach ($kelasList as $kelas)
                            <li class="submenu-item {{ request('kelas') == $kelas->id_mkelas ? 'active' : '' }}">
                                <a href="{{ route('absensi.index', ['kelas' => $kelas->id_mkelas]) }}" class="submenu-link">
                                    Kelas {{ strtoupper($kelas->nama_kelas) }}
                                </a>
                            </li>
                        ...
                        {{-- @foreach ($kelasList as $kelas)
                            <li>
                                <a href="{{ route('absensi.index', ['kelas' => $kelas->id_mkelas]) }}">
                                    {{ $kelas->nama_kelas }} | {{ $kelas->id_mkelas }}
                                </a>
                            </li>
                        @endforeach --}}
                ...
                {{-- <li
                    class="sidebar-item {{ Route::is('absensi*') ? 'active' : '' }} ">
                    <a href="{{ route('absensi.index', ['kelas' => $kelas->id_mkelas]) }}" class="sidebar-link">
                ...
                <li
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item {{ Route::is('rekapsiswa*') ? 'active' : '' }} ">
                            <a href="{{ route('rekapsiswa') }}" class="submenu-link">
                                {{-- <i class="bi bi-person-badge-fill"></i> --}}
